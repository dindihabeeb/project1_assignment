...
- **C Compilation Stages:** 
   ...
   - into machine language (binary format). The input file is a .s file, and the output file is a .o object code in binary. The -c flag is used when creating an object code from an input compiled file. 

## e.g., _gcc -c main.s -o main.o_ 
